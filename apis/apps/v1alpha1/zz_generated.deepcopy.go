...
func (in *ClusterBackup) DeepCopyInto(out *ClusterBackup) {
	*out = *in
	...
	if in.IncrementalBackupEnabled != nil {
		in, out := &in.IncrementalBackupEnabled, &out.IncrementalBackupEnabled
		*out = new(bool)
		**out = **in
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HelmTypeSpec) DeepCopyInto(out *HelmTypeSpec) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HelmTypeSpec.
func (in *HelmTypeSpec) DeepCopy() *HelmTypeSpec {
	if in == nil {
		return nil
	}
	out := new(HelmTypeSpec)
...
func (in *InstallSpec) DeepCopyInto(out *InstallSpec) {
	*out = *in
	if in.HelmInstallValues != nil {
		in, out := &in.HelmInstallValues, &out.HelmInstallValues
		*out = make(map[string]string, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
...
func (in *MultipleClusterObjectOption) DeepCopyInto(out *MultipleClusterObjectOption) {
	*out = *in
	if in.RequireAllComponentObjects != nil {
		in, out := &in.RequireAllComponentObjects, &out.RequireAllComponentObjects
		*out = new(bool)
		**out = **in
	}
